...
func map_inputs(prefix, input_method):
	InputMap.action_add_event(prefix + "left", create_input(input_method, KEY_LEFT, JOY_DPAD_LEFT))
	InputMap.action_add_event(prefix + "right", create_input(input_method, KEY_RIGHT, JOY_DPAD_RIGHT))
	InputMap.action_add_event(prefix + "up", create_input(input_method, KEY_UP, JOY_DPAD_UP))
	InputMap.action_add_event(prefix + "down", create_input(input_method, KEY_DOWN, JOY_DPAD_DOWN))
	InputMap.action_add_event(prefix + "a", create_input(input_method, KEY_A, JOY_SONY_SQUARE))
	InputMap.action_add_event(prefix + "b", create_input(input_method, KEY_S, JOY_SONY_TRIANGLE))
	InputMap.action_add_event(prefix + "c", create_input(input_method, KEY_D, JOY_SONY_CIRCLE))
	InputMap.action_add_event(prefix + "d", create_input(input_method, KEY_F, JOY_SONY_X))
	InputMap.action_add_event(prefix + "ab", create_input(input_method, KEY_E, JOY_R))
	if input_method == 0:
